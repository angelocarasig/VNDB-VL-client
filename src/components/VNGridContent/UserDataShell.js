      ...
      header={
        <Header height={70} p="md">
          ...
          <MediaQuery largerThan="sm" styles={{ display: "none" }}>
            ...
            <div className="leftItems" style={leftItems} onClick={() => {navigateTo("/")}}>
              {titleSize ? [<Title order={2}>VNDB-Visualizer</Title>, <i style={iconStyle}/>] : [<Title order={2}>VNDB-VL</Title>]}
            </div>

            <div className="rightItems" style={{ width: "100%", right: 0, display: "flex", justifyContent: "flex-end"}}>
              <LightDarkSwitch />
            </div>
